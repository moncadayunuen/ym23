...
Route::get('/projects/category/{category}', 'IndexController@categoryProjects')->name('projects.categories');
Route::get('/projects/{project}', 'IndexController@showProject')->name('projects.show');

Route::get('/blog', 'IndexController@blog')->name('blog.index');
Route::get('/blog/{post}', 'IndexController@showBlogPost')->name('blog.show');
Route::get('/blog/category/{category}', 'IndexController@categories')->name('blog.categories');
...
Route::middleware('auth')->namespace('Admin')->prefix('admin')->group(function() {
  ...
  Route::get('/proyectos/categorias', 'ProjectsCategoriesController@index')
    ->name('admin.projects.categories.index')
    ->middleware('permission:Ver categorias de proyectos');
  ...
  Route::get('/proyectos', 'ProjectsController@index')
    ...
    ->middleware('permission:Ver proyectos');
  Route::get('/proyectos/crear', 'ProjectsController@create')
  ...
  Route::get('/curriculum', 'CareerController@index')
    ->name('admin.cv.index')
  ...
  Route::get('/publicaciones/categorias', 'CategoriesController@index')
    ...
    ->middleware('permission:Ver categorías');
  Route::get('/publicaciones/categorias/crear', 'CategoriesController@create')
    ->name('admin.categories.create')
    ->middleware('permission:Crear categorías');
  ...
  Route::get('/publicaciones', 'PostsController@index')
    ...
    ->middleware('permission:Ver publicaciones');
  Route::get('/publicaciones/crear', 'PostsController@create')
    ->name('admin.posts.create')
    ->middleware('permission:Crear publicaciones');
  ...
  Route::get('/roles/crear', 'RolesController@create')
