    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item">Roles de Usuario</li>
        </ol>
      </div>
    </div>
  </div>
        ...
        <div class="card card-dark card-outline">
          <div class="py-2 px-3">
            <div class="d-flex justify-content-between">
              ...
              <a href="{{ route('admin.roles.create') }}" class="btn btn-primary"><i class="fa fa-user-alt mr-2"></i>Nuevo Role</a>
            </div>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-content-center align-items-center">
                      <a href="{{ route('admin.roles.edit', $role) }}" class="btn btn-primary badge badge-primary mx-1"><i class="fa fa-pencil-alt mr-1"></i> Editar</a>
                      @if ($role->id !== 1)
