...
@section('content')
@if (count($posts) > 0)
<section class="top-category-widget-area py-3">
          ...
          <div class="content relative">
            ...
            <a href="{{ route('blog.categories', $postCategory->url) }}" target="_blank">
              <div class="thumb bg-dark">
                <a href="{{ route('blog.categories', $postCategory->url) }}"><img class="content-image img-fluid d-block mx-auto" src="{{ url($postCategory->thumbnail) }}" alt=""></a>
              </div>
              <a href="{{ route('blog.categories', $postCategory->url) }}">
...
<section class="post-content-area">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 sidebar-widgets mb-2">
