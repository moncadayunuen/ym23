...
$config['licenseName'] = 'ym23.com.mx';
$config['licenseKey']  = '*G?J-*1**-5**K-*5**-*J**-6*C*-A**F';
...
$config['images'] = array(
    ...
    'sizes' => array(
        ...
        'medium' => array('width' => 1200, 'height' => 628, 'quality' => 80),
        'large'  => array('width' => 1980, 'height' => 10800, 'quality' => 80)
    )
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'files',
    'maxSize'           => 0,
    'allowedExtensions' => '7z,aiff,asf,csv,doc,docx,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wma,wmv,xls,xlsx,zip',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
