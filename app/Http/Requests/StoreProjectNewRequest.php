...
class StoreProjectNewRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'created' => 'required',
            'thumbnail' => 'required|image|mimes:jpeg,jpg,png,svg,gift|dimensions:width=460,height=530|max:1048',
            'content' => 'required'
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'thumbnail.required' => 'Se necesita subir un thumbnail para el proyecto',
